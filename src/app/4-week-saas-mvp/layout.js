...
export async function generateMetadata() {
  const hub = globalHubsData["4-week-saas-mvp"];
  return {
    title: hub.metaTitle,
    description: hub.metaDescription,
    keywords: hub.keywords,
    alternates: {
      canonical: "https://chittortech.in/4-week-saas-mvp",
    },
    openGraph: {
      title: hub.metaTitle,
      description: hub.metaDescription,
      url: "https://chittortech.in/4-week-saas-mvp",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "name": hub.name,
            "item": "https://chittortech.in/4-week-saas-mvp"
          }
        ]
      }
    ]
