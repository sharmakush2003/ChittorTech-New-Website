      ...
      <div className="row">
         <div className="col-md-12">
            ...
            <div className="why-choose-wrap">
               <ul>
                  <li>
                     <figure> <img src="/assets/images/ce1.png" alt="ChittorTech Departmental Hypermarket Store - ce1" /> </figure>
                     <h3>4X revenue growth rate</h3>
                  </li>
                  <li>
                     <figure> <img src="/assets/images/ce2.png" alt="ChittorTech Departmental Hypermarket Store - ce2" /> </figure>
                     <h3>120+ billing hours saved per month</h3>
                  </li>
                  <li>
                     <figure> <img src="/assets/images/ce3.png" alt="ChittorTech Departmental Hypermarket Store - ce3" /> </figure>
                     <h3>90% faster processing time</h3>
                  </li>
                  <li>
                     <figure> <img src="/assets/images/ce4.png" alt="ChittorTech Departmental Hypermarket Store - ce4" /> </figure>
         ...
         <div className="col-md-12">
             <div className="heading-wrap text-center">
              ...
              <div className="why-choose-wrap">
                 <ul>
                    <li>
                       <figure> <img src="/assets/images/ns1.png" alt="ChittorTech Departmental Hypermarket Store - ns1" /> </figure>
                       <h3>AI E-Commerce Sync</h3>
                    </li>
                    <li>
                       <figure> <img src="/assets/images/ns2.png" alt="ChittorTech Departmental Hypermarket Store - ns2" /> </figure>
                       <h3>AI Marketing & Communication</h3>
                    </li>
                    <li>
                       <figure> <img src="/assets/images/ns3.png" alt="ChittorTech Departmental Hypermarket Store - ns3" /> </figure>
                       <h3>AI Payment Processing</h3>
                    </li>
                    <li>
                       <figure> <img src="/assets/images/ns4.png" alt="ChittorTech Departmental Hypermarket Store - ns4" /> </figure>
                       <h3>AI Business App Connect
</h3>
                    </li>
                    <li>
                       <figure> <img src="/assets/images/ns5.png" alt="ChittorTech Departmental Hypermarket Store - ns5" /> </figure>
                       <h3>AI Shipping & Logistics</h3>
                    </li>
                    <li>
                       <figure> <img src="/assets/images/ns6.png" alt="ChittorTech Departmental Hypermarket Store - ns6" /> </figure>
          ...
          <div className="row">
            <div className="col-md-6 col-lg-4 mb-4">
              <div className="card service-box text-center p-4 animate-in" data-delay="0">
                <figure> <img src="/assets/images/ft1.png" alt="ChittorTech Departmental Hypermarket Store - ft1" /> </figure>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <div className="card service-box text-center p-4 animate-in" data-delay="100">
                <figure> <img src="/assets/images/ft2.png" alt="ChittorTech Departmental Hypermarket Store - ft2" /> </figure>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <div className="card service-box text-center p-4 animate-in" data-delay="200">
                <figure> <img src="/assets/images/ft3.png" alt="ChittorTech Departmental Hypermarket Store - ft3" /> </figure>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <div className="card service-box text-center p-4 animate-in" data-delay="300">
                <figure> <img src="/assets/images/ft4.png" alt="ChittorTech Departmental Hypermarket Store - ft4" /> </figure>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <div className="card service-box text-center p-4 animate-in" data-delay="400">
                <figure> <img src="/assets/images/ft5.png" alt="ChittorTech Departmental Hypermarket Store - ft5" /> </figure>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <div className="card service-box text-center p-4 animate-in" data-delay="400">
                <figure> <img src="/assets/images/ft6.png" alt="ChittorTech Departmental Hypermarket Store - ft6" /> </figure>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <div className="card service-box text-center p-4 animate-in" data-delay="400">
                <figure> <img src="/assets/images/ft7.png" alt="ChittorTech Departmental Hypermarket Store - ft7" /> </figure>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <div className="card service-box text-center p-4 animate-in" data-delay="400">
                <figure> <img src="/assets/images/ft8.png" alt="ChittorTech Departmental Hypermarket Store - ft8" /> </figure>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <div className="card service-box text-center p-4 animate-in" data-delay="400">
                <figure> <img src="/assets/images/ft9.png" alt="ChittorTech Departmental Hypermarket Store - ft9" /> </figure>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <div className="card service-box text-center p-4 animate-in" data-delay="400">
                <figure> <img src="/assets/images/ft10.png" alt="ChittorTech Departmental Hypermarket Store - ft10" /> </figure>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <div className="card service-box text-center p-4 animate-in" data-delay="400">
                <figure> <img src="/assets/images/ft11.png" alt="ChittorTech Departmental Hypermarket Store - ft11" /> </figure>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <div className="card service-box text-center p-4 animate-in" data-delay="400">
                <figure> <img src="/assets/images/ft12.png" alt="ChittorTech Departmental Hypermarket Store - ft12" /> </figure>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <div className="card service-box text-center p-4 animate-in" data-delay="400">
                <figure> <img src="/assets/images/ft13.png" alt="ChittorTech Departmental Hypermarket Store - ft13" /> </figure>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <div className="card service-box text-center p-4 animate-in" data-delay="400">
                <figure> <img src="/assets/images/ft14.png" alt="ChittorTech Departmental Hypermarket Store - ft14" /> </figure>
