      ...
      <div className="row">
         <div className="col-md-12">
            <div className="heading-wrap">
               ...
               <p>ChittorTech provides an extensive range of features to help you run your supermarket operations efficiently, improve customer satisfaction, and increase profitability.</p>
            </div>
                        ...
                        <div className="flip-card">
                           <div className="flip-card-inner">
                              <div className="flip-card-back">
                                 ...
                                 <p>A simple and intuitive AI Assistant Software designed for supermarkets. Supports multiple payment options (cash, card, UPI, wallets) and works seamlessly on any device.</p>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div className="flip-card">
                           <div className="flip-card-inner">
                              <div className="flip-card-back">
                                 ...
                                 <h4>Customer Relationship Management (AI Knowledge Base)</h4>
                  ...
                  <div className="col-md-4 col-12 mb-4">
                     <div className="boxes flip-container">
                        <div className="flip-card">
                           <div className="flip-card-inner">
                              <div className="flip-card-back">
                                 <img src="/assets/images/fe5.png" alt="Label/Barcode Generator" className="img-fluid mb-3" />
                  ...
                  <div className="col-md-4 col-12 mb-4">
                     <div className="boxes flip-container">
                        <div className="flip-card">
                           <div className="flip-card-inner">
                              <div className="flip-card-back">
                                 <img src="/assets/images/fe6.png" alt="WhatsApp Integration" className="img-fluid mb-3" />
                  ...
                  <div className="col-md-4 col-12 mb-4">
                     <div className="boxes flip-container">
                        <div className="flip-card">
                           <div className="flip-card-inner">
                              <div className="flip-card-back">
                                 <img src="/assets/images/fe7.png" alt="Online Store" className="img-fluid mb-3" />
                  ...
                  <div className="col-md-4 col-12 mb-4">
                     <div className="boxes flip-container">
                        <div className="flip-card">
                           <div className="flip-card-inner">
                              <div className="flip-card-back">
                                 <img src="/assets/images/fe8.png" alt="Loyalty/Membership Points" className="img-fluid mb-3" />
                  ...
                  <div className="col-md-4 col-12 mb-4">
                     <div className="boxes flip-container">
                        <div className="flip-card">
                           <div className="flip-card-inner">
                              <div className="flip-card-back">
                                 <img src="/assets/images/fe10.png" alt="GST-Compliant Billing" className="img-fluid mb-3" />
                  ...
                  <div className="col-md-4 col-12 mb-4">
                     <div className="boxes flip-container">
                        <div className="flip-card">
                           <div className="flip-card-inner">
                              <div className="flip-card-back">
                                 <img src="/assets/images/fe11.png" alt="E-Invoicing" className="img-fluid mb-3" />
         ...
         <div className="col-md-4 mb-4">
            <div className="pricing-card standard">
               ...
               <ul className="pricing-features">
                  ...
                  <li>✔ AI Knowledge Base & WhatsApp Integration</li>
               </ul>
            </div>
         </div>
         {/* Premium Plan */}
      ...
      <div className="row">
         <div className="col-md-12">
            <div className="bridal-store">
               ...
               <p>Supermarket chains and franchises need more than just billing software — they need a centralized system that streamlines operations across all locations. A modern Supermarket AI Assistant Software helps you manage multiple branches efficiently, ensuring smooth workflows and better customer experiences.</p>
            </div>
         </div>
      </div>
   </div>
...
<section className="why-choose-sec bridal-sec">
   ...
   <div className="expertise-wrap bridal-wrap">
      <ul>
         ...
         <li><strong>AI Centralized Accounting & AI Knowledge Base –</strong> Automate financial management and customer engagement.</li>
      ...
      <div className="row">
         <div className="col-md-12">
            ...
            <div className="why-choose-wrap">
               <ul>
                  <li>
                     <figure> <img src="/assets/images/platforms1.png" alt="ChittorTech Supermarket - platforms1" /> </figure>
                     <h3>4X Revenue Growth Rate</h3>
                  </li>
                  <li>
                     <figure> <img src="/assets/images/platforms2.png" alt="ChittorTech Supermarket - platforms2" /> </figure>
                     <h3>120+ Billing Hours Saved per Month</h3>
                  </li>
                  <li>
                     <figure> <img src="/assets/images/platforms3.png" alt="ChittorTech Supermarket - platforms3" /> </figure>
                     <h3>90% Faster Processing Time</h3>
                  </li>
                  <li>
                     <figure> <img src="/assets/images/platforms4.png" alt="ChittorTech Supermarket - platforms4" /> </figure>
                  ...
                  <div className="accordion-item">
                     <h2 className="accordion-header" id="heading1">
                        <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="true" aria-controls="collapse1">
                           1. What is ChittorTech Supermarket Software?
                        </button>
                     </h2>
