...
export async function generateMetadata() {
  const hub = globalHubsData["timezone-overlap"];
  return {
    title: hub.metaTitle,
    description: hub.metaDescription,
    keywords: hub.keywords,
    alternates: {
      canonical: "https://chittortech.in/timezone-overlap",
    },
    openGraph: {
      title: hub.metaTitle,
      description: hub.metaDescription,
      url: "https://chittortech.in/timezone-overlap",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "name": hub.name,
            "item": "https://chittortech.in/timezone-overlap"
          }
        ]
      }
    ]
