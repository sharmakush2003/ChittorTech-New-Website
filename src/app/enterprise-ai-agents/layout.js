...
export async function generateMetadata() {
  const hub = globalHubsData["enterprise-ai-agents"];
  return {
    title: hub.metaTitle,
    description: hub.metaDescription,
    keywords: hub.keywords,
    alternates: {
      canonical: "https://chittortech.in/enterprise-ai-agents",
    },
    openGraph: {
      title: hub.metaTitle,
      description: hub.metaDescription,
      url: "https://chittortech.in/enterprise-ai-agents",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "name": hub.name,
            "item": "https://chittortech.in/enterprise-ai-agents"
          }
        ]
      }
    ]
