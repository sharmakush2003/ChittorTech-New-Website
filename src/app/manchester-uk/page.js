...
export default function ManchesterUKPage() {
  const [teamSize, setTeamSize] = useState(3);
  const [durationMonths, setDurationMonths] = useState(6);
  const [selectedService, setSelectedService] = useState(0);
  const [openFaq, setOpenFaq] = useState(0);

  // Manchester & Northern Powerhouse Benchmark Rates:
  // Senior Developer / Agency Contractor: ~£85/hr
  // ChittorTech Senior Developer: ~£30/hr
  const hoursPerMonth = 160;
  const localRatePerHour = 85;
  const ctRatePerHour = 30;
  ...
  const services = [
  {
    "id": "ecom-web",
    "tabLabel": "E-Com & Web",
    "name": "High-Speed Headless E-Commerce & Next.js 15 Portals",
    "badge": "Headless Shopify, MedusaJS & Fast Checkout",
    "icon": "fa-solid fa-cart-shopping",
    "description": "Engineered for Manchester's digital retail brands, fashion retailers, and Northern Powerhouse scale-ups using Next.js 15, React 19, and Tailwind CSS.",
    "deliverables": [
      "Headless Shopify, MedusaJS, and custom Next.js e-commerce storefronts",
      "Sub-second Core Web Vitals deployed on UK edge CDN nodes",
      "Klarna, Clearpay, Apple Pay, and Stripe UK payment integration",
      "High-volume inventory and warehouse ERP integration with automated sync",
      "Automated end-to-end regression testing ensuring 100% checkout uptime"
    ],
    "techSpecs": "Next.js 15, React 19, TypeScript, Tailwind CSS, Supabase, AWS eu-west-2"
  },
  {
    "id": "logistics-ai",
    "tabLabel": "Logistics AI",
    "name": "Warehouse Automation & Customer Support AI Agents",
    "badge": "Groq LPUs, Private RAG & WhatsApp Support",
    "icon": "fa-solid fa-brain",
    "description": "Deploy private autonomous conversational AI agents and sub-second LLM workflows that handle order tracking, dispatch inquiries, and customer support 24/7 across the UK.",
    "deliverables": [
      "Sub-500ms streaming response times powered by Groq LPU hardware and Llama 3.3",
      "Private document RAG pipelines searching product catalogs and shipping policies",
      "WhatsApp Business Cloud API automation for instant tracking and order updates",
  ...
  },
  {
    ...
    "name": "Cross-Platform Retail & Logistics Mobile Applications",
    "badge": "React Native, Expo & Barcode Scanning",
    "icon": "fa-solid fa-mobile-screen-button",
    "description": "Fluid iOS & Android applications engineered for warehouse logistics, dispatch tracking, and consumer mobile shopping with native Apple Pay support.",
    "deliverables": [
  ...
  },
  {
    ...
    "name": "AWS UK & Cloudflare Edge High-Concurrency Infrastructure",
    "badge": "AWS eu-west-2 & Cloudflare Edge",
    "icon": "fa-solid fa-server",
    "description": "Resilient cloud networking, automated CI/CD pipelines, and high-concurrency database connection pooling designed for UK retail scale-ups requiring 99.99% uptime.",
    "deliverables": [
      "Sovereign UK data residency guaranteed on AWS UK (eu-west-2)",
  ...
  },
  {
    "id": "seo-growth",
    "tabLabel": "SEO & Growth",
    "name": "Google UK E-Commerce Programmatic SEO & GA4 Funnels",
    "badge": "Organic Search Dominance & Analytics",
    "icon": "fa-solid fa-magnifying-glass-chart",
    "description": "Dominate competitive UK retail and e-commerce search queries with programmatic SEO architectures, automated XML sitemaps, and conversion-focused GA4 measurement.",
    "deliverables": [
      ...
      "Product and Organization Schema.org JSON-LD structured data markup",
  ...
  const faqs = [
    {
      q: "How does ChittorTech partner with Manchester digital agencies?",
      a: "Manchester is the creative and digital capital of the North. We act as a white-label or co-development engineering partner for agencies experiencing capacity crunches. You lead client strategy and UI/UX design; our senior engineers build the full-stack Next.js web applications and mobile apps behind the scenes under strict white-label NDAs."
    },
    {
      q: "What is your timezone overlap with Manchester (BST / GMT)?",
      a: "Manchester shares the same BST/GMT timezone as London. With only a 4.5 to 5.5 hour time difference with India, your 9:00 AM to 2:00 PM UK working hours overlap directly with our active afternoon. You get 5 hours of live synchronous collaboration every single day."
    },
    {
      q: "Are Manchester businesses protected from IR35 liabilities?",
      a: "Yes, completely. ChittorTech is an offshore technology consultancy. Because our developers are fully employed by ChittorTech outside the UK, your business is 100% exempt from IR35 off-payroll working rules and employer National Insurance contributions."
    },
    {
      q: "How do your rates compare to local Manchester contractors?",
      a: "Senior software engineers and agency contractors in Greater Manchester command £75 to £95/hr. ChittorTech provides dedicated senior full-stack developers at £30/hr—saving you up to 65% on engineering payroll."
    },
    {
      q: "Can we test your team before signing a long-term agreement?",
      a: "Yes. We offer a 2-Week Risk-Free Technical Pilot. Assign real tasks from your backlog; if our velocity, code quality, and communication do not exceed your standards, you pay nothing."
    },
    {
      q: "How do you handle IP rights and confidential client data?",
      a: "We execute bilateral UK-compliant NDAs before technical discussions. Our Master Service Agreements include ironclad work-for-hire clauses transferring 100% intellectual property, code repositories, and documentation to your UK business."
    }
  ];

  return (
    <div className="manchester-page" style={{
      ...
      <style>{`
        .manchester-page h1, .manchester-page h2, .manchester-page h3, .manchester-page h4, .manchester-page h5 {
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "1180px", margin: "0 auto", textAlign: "center", position: "relative", zIndex: 2 }}>
          ...
          <div style={{
            ...
            <span>MANCHESTER &amp; NORTHERN POWERHOUSE TECH</span>
          ...
          <h1 style={{
            ...
            Dedicated Software Engineering for <span className="cyan-gradient-text">Manchester Agencies &amp; Scale-Ups</span>
          </h1>
          ...
          <p style={{
            ...
            From MediaCityUK to Spinningfields, supercharge your engineering capacity. Deploy senior Next.js full-stack developers, WhatsApp conversational AI bots, and cloud architectures with 5 hours of live BST overlap and zero IR35 liabilities.
          </p>
          ...
          <div className="hub-stats-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(210px, 1fr))",
            ...
            <div>
              <div style={{ fontSize: "32px", fontWeight: 900, color: "#34d399" }}>65%</div>
              <div style={{ fontSize: "14px", color: "#94a3b8", marginTop: "4px" }}>Manchester Payroll Saved</div>
            </div>
            <div>
            ...
            <div>
              <div style={{ fontSize: "32px", fontWeight: 900, color: "#a855f7" }}>White-Label</div>
              <div style={{ fontSize: "14px", color: "#94a3b8", marginTop: "4px" }}>Agency Overflow Ready</div>
            </div>
          </div>
      ...
      {/* ─── Interactive Manchester Cost Calculator ─── */}
      <section style={{ padding: "80px 20px", maxWidth: "1140px", margin: "0 auto" }}>
        <div className="manchester-card" style={{ padding: "40px 32px", border: "1px solid rgba(56, 189, 248, 0.25)" }}>
          <div style={{ textAlign: "center", marginBottom: "36px" }}>
            ...
            <h2 style={{ fontSize: "clamp(26px, 3.5vw, 36px)", marginTop: "8px", color: "#ffffff" }}>
              Compare Manchester Agency / Contractor Rates vs ChittorTech Pods
            </h2>
            <p style={{ maxWidth: "680px", margin: "10px auto 0", fontSize: "15px" }}>
              Benchmark based on standard Manchester contractor rates of <strong>£85/hr</strong> vs ChittorTech’s dedicated senior pod rate of <strong>£30/hr</strong>.
            </p>
          </div>
          ...
          <div className="hub-calc-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "32px", alignItems: "center" }}>
            ...
            <div className="hub-calc-summary" style={{ background: "rgba(30, 41, 59, 0.5)", border: "1px solid rgba(255, 255, 255, 0.12)", borderRadius: "16px", padding: "28px" }}>
              <div className="hub-calc-row" style={{ display: "flex", justifyContent: "space-between", marginBottom: "14px", fontSize: "14px", flexWrap: "wrap", gap: "6px" }}>
                <span style={{ color: "#94a3b8" }}>Manchester Agency Benchmark:</span>
      ...
      <section style={{ padding: "60px 20px 80px", maxWidth: "1180px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "48px" }}>
          ...
          <h2 style={{ fontSize: "clamp(26px, 4vw, 40px)", marginTop: "8px", color: "#ffffff" }}>
            Software Engineering Built for the North's Digital Leaders
          </h2>
          <p style={{ maxWidth: "720px", margin: "12px auto 0", fontSize: "16px" }}>
            From high-velocity Next.js web applications to automated WhatsApp AI bots, we build responsive digital platforms that convert traffic into revenue.
          </p>
        </div>
        ...
        <div className="manchester-card" style={{ padding: "40px", border: "1px solid rgba(56, 189, 248, 0.3)" }}>
        ...
        <div className="hub-features-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "24px" }}>
          ...
          <div className="manchester-card" style={{ padding: "32px" }}>
            <div style={{ width: "48px", height: "48px", borderRadius: "12px", background: "rgba(56, 189, 248, 0.15)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "20px" }}>
              <i className="fa-solid fa-handshake" style={{ color: "#38bdf8", fontSize: "20px" }}></i>
            </div>
            <h3 style={{ fontSize: "20px", marginBottom: "12px", color: "#ffffff" }}>Agency Overflow Partner</h3>
            <p style={{ fontSize: "14px", lineHeight: 1.65 }}>
              Scale up your engineering bandwidth without hiring full-time staff. We operate under strict white-label agreements, enabling Manchester digital agencies to pitch and deliver larger web and mobile contracts with healthy margins.
            </p>
          </div>
          ...
          <div className="manchester-card" style={{ padding: "32px" }}>
            ...
            <p style={{ fontSize: "14px", lineHeight: 1.65 }}>
              Enjoy 5 hours of direct synchronous overlap with your Manchester team (9:00 AM - 2:00 PM BST). Run daily morning standups, review live pull requests, and wake up to tested commits shipped overnight.
            </p>
          </div>
          ...
          <div className="manchester-card" style={{ padding: "32px" }}>
            ...
            <h3 style={{ fontSize: "20px", marginBottom: "12px", color: "#ffffff" }}>Zero IR35 &amp; Full IP Ownership</h3>
            <p style={{ fontSize: "14px", lineHeight: 1.65 }}>
              Airtight legal compliance with full work-for-hire assignment, comprehensive bilateral NDAs executed within 2 hours, and 100% exemption from HMRC IR35 rules.
            </p>
          </div>
      ...
      <section style={{ padding: "60px 20px 80px", maxWidth: "980px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          <h2 style={{ fontSize: "clamp(26px, 3.5vw, 36px)", color: "#ffffff" }}>
            Frequently Asked Questions by Manchester Founders
          </h2>
          <p style={{ fontSize: "15px", marginTop: "8px" }}>
            Clear details regarding white-label agency partnerships, IR35, and trials.
          </p>
        </div>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "860px", margin: "0 auto" }}>
          <h2 style={{ fontSize: "clamp(28px, 4.5vw, 44px)", color: "#ffffff", marginBottom: "18px" }}>
            Ready to Accelerate Your Manchester Engineering Roadmap?
          </h2>
          ...
          <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <a
              href="https://wa.me/919929828456?text=Hello%20ChittorTech%2C%20we%20are%20a%20Manchester%20business%20interested%20in%20dedicated%20engineering%20pods."
              target="_blank"
