...
export async function generateMetadata() {
  const hub = globalHubsData["sydney-australia"];
  return {
    title: hub.metaTitle,
    description: hub.metaDescription,
    keywords: hub.keywords,
    alternates: {
      canonical: "https://chittortech.in/sydney-australia",
    },
    openGraph: {
      title: hub.metaTitle,
      description: hub.metaDescription,
      url: "https://chittortech.in/sydney-australia",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "name": hub.name,
            "item": "https://chittortech.in/sydney-australia"
          }
        ]
      }
    ]
