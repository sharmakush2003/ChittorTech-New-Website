...
export async function generateMetadata() {
  const hub = globalHubsData["dedicated-tech-teams"];
  return {
    title: hub.metaTitle,
    description: hub.metaDescription,
    keywords: hub.keywords,
    alternates: {
      canonical: "https://chittortech.in/dedicated-tech-teams",
    },
    openGraph: {
      title: hub.metaTitle,
      description: hub.metaDescription,
      url: "https://chittortech.in/dedicated-tech-teams",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "name": hub.name,
            "item": "https://chittortech.in/dedicated-tech-teams"
          }
        ]
      }
    ]
