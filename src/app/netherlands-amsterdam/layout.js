...
export async function generateMetadata() {
  const hub = globalHubsData["netherlands-amsterdam"];
  return {
    title: hub.metaTitle,
    description: hub.metaDescription,
    keywords: hub.keywords,
    alternates: {
      canonical: "https://chittortech.in/netherlands-amsterdam",
    },
    openGraph: {
      title: hub.metaTitle,
      description: hub.metaDescription,
      url: "https://chittortech.in/netherlands-amsterdam",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "name": hub.name,
            "item": "https://chittortech.in/netherlands-amsterdam"
          }
        ]
      }
    ]
